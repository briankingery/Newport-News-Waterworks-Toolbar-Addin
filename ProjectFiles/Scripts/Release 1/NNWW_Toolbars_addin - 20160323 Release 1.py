## Brian Kingery
## 3/22/2016
## NNWW_Toolbars_addin.py

## User must run Update Local GIS Features to maximize add-in

import arcpy, pythonaddins, string, os, time, xlrd, xlwt, datetime#, webbrowser
...
def SendStatusMail_Intersection():
    ...
    mailSender = '%s <%s@nnva.gov>' % (os.environ['USERNAME'], os.environ['USERNAME'])
    subject = 'NNWW Toolbars Python Add-in'
    body  = 'Street Intersection is being used!\r\n\n'
    body += 'This is an automatically generated message.  Please do not reply.\r\n'
    message = ''
    message += 'From: %s\r\n' % mailSender
    message += 'To: %s\r\n' % ', '.join(mailRecipients)
...
def SendStatusMail_NewProject():
    ...
    mailSender = '%s <%s@nnva.gov>' % (os.environ['USERNAME'], os.environ['USERNAME'])
    subject = 'NNWW Toolbars Python Add-in'
    body  = 'New Project Data Extractor is being used!\r\n\n'
    body += 'This is an automatically generated message.  Please do not reply.\r\n'
    message = ''
    message += 'From: %s\r\n' % mailSender
    message += 'To: %s\r\n' % ', '.join(mailRecipients)
                                    ...
                                    if lyr.name == StreetIntersectionPoint:
                                        ...
                                        if count3 != 0:
                                            ...
                                            for lyr in arcpy.mapping.ListLayers(mxd,'Add-In Str*',df):
                                                lyr.showLabels = True
                                            # Update Symbology
                                            sourceLayerStreet1          = arcpy.mapping.Layer(r'R:\Divisions\InfoTech\Shared\GIS\Python_Addins\addin_assistant\Projects\MyTools\NNWW_Toolbars\ProjectFiles\Street1Symbology.lyr')
                                            sourceLayerStreet2          = arcpy.mapping.Layer(r'R:\Divisions\InfoTech\Shared\GIS\Python_Addins\addin_assistant\Projects\MyTools\NNWW_Toolbars\ProjectFiles\Street2Symbology.lyr')
                                            sourceLayerIntersection     = arcpy.mapping.Layer(r'R:\Divisions\InfoTech\Shared\GIS\Python_Addins\addin_assistant\Projects\MyTools\NNWW_Toolbars\ProjectFiles\Intersection.lyr')
                                            for lyr in arcpy.mapping.ListLayers(mxd,'',df):
...
class ButtonClass_1_AddCADIndex(object):
    ...
    def onClick(self):
        ...
        # Update Symbology
        CADIndexLayer = arcpy.mapping.Layer(r'R:\Divisions\InfoTech\Shared\GIS\Python_Addins\addin_assistant\Projects\MyTools\NNWW_Toolbars\ProjectFiles\CADIndex.lyr')
        for lyr in arcpy.mapping.ListLayers(mxd,'',df):
            ...
            for drawing in selected_drawings:
                ...
                if fileType == 'DWG':
                    try:                        
                        ...
                        TEMPLayer           = arcpy.mapping.Layer(r'R:\Divisions\InfoTech\Shared\GIS\Python_Addins\addin_assistant\Projects\MyTools\NNWW_Toolbars\ProjectFiles\tempGroup.lyr')
...
##            arcpy.RefreshActiveView()
            ...
            if dwgCount > 0 or dxfCount > 0 or tifCount > 0:
                temporaryGL = arcpy.mapping.Layer(r'R:\Divisions\InfoTech\Shared\GIS\Python_Addins\addin_assistant\Projects\MyTools\NNWW_Toolbars\ProjectFiles\temp.lyr')
                arcpy.mapping.AddLayer(df, temporaryGL, "BOTTOM")                
                MainGroupLayer = arcpy.mapping.Layer(r'R:\Divisions\InfoTech\Shared\GIS\Python_Addins\addin_assistant\Projects\MyTools\NNWW_Toolbars\ProjectFiles\Drawings & Historical Orthophotographs.lyr')
...
class ToolClass_1_DataExtractor(object):
    ...
    def onRectangle(self, rectangle_geometry):
        env.workspace = "R:/Divisions/InfoTech/Shared/GIS/NewProjectApplication/ExtractionFolder"
        ...
        print "The folder is located at location --> R:\Divisions\InfoTech\Shared\GIS\NewProjectApplication\ExtractionFolder"
        print "Please wait while data compiles..."

        event = str(title)
        projectFolder = 'R:/Divisions/InfoTech/Shared/GIS/NewProjectApplication/ExtractionFolder/' + event
        ...
        ## Hydrant
        ##
        hydrant = r"R:\Divisions\InfoTech\Shared\GIS\NewProjectApplication\Hidden\Conway_sdeVector_sdeViewer.sde\SDEVECTOR.SDEDATAOWNER.V_HYDRANT_EAM"
        ...
        ## Mainbreak
        ##
        Mainbreak = r"\\nile\applications\Databases\Engineering\Data\Distribution_GeoDB.mdb\Mainbreaks"
        ...
        ## Valve
        ##
        valve = r"R:\Divisions\InfoTech\Shared\GIS\NewProjectApplication\Hidden\Conway_sdeVector_sdeViewer.sde\SDEVECTOR.SDEDATAOWNER.V_SYSTEMVALVE_EAM"
        ...
        ## Abandoned Pipe
        ##
        abandonedPipe = r"R:\Divisions\InfoTech\Shared\GIS\NewProjectApplication\Hidden\Conway_sdeVector_sdeViewer.sde\SDEVECTOR.SDEDATAOWNER.V_WPRESSURIZEDMAINABANDONED"
        ...
        ## Main
        ##
        main = r"R:\Divisions\InfoTech\Shared\GIS\NewProjectApplication\Hidden\Conway_sdeVector_sdeViewer.sde\SDEVECTOR.SDEDATAOWNER.V_WPRESSURIZEDMAIN"
        ...
        ##
        easement = r"\\nile\applications\Databases\Engineering\Data\Distribution_GeoDB.mdb\Easements"
        ...
        ## Fiber Cable
        ##
        fiber = r"R:\Divisions\InfoTech\Shared\GIS\NewProjectApplication\Hidden\Conway_sdeVector_sdeViewer.sde\sdeVector.SDEDATAOWNER.OtherUtility\sdeVector.SDEDATAOWNER.FiberOpticLine"
        ...
        ## Fireflow
        ##
        fireflow = r"\\nile\applications\Databases\Engineering\Data\Distribution_GeoDB.mdb\Fireflows"
        ...
        ##
        dsi = r"R:\Divisions\InfoTech\Shared\GIS\NewProjectApplication\Hidden\Conway_sdeVector_sdeViewer.sde\sdeVector.SDEDATAOWNER.DSIPriority\sdeVector.sdeDataOwner.DSIPrioritizedArea"
        ...
        ## Current Project
        ##
        currentProject = r"R:\Divisions\InfoTech\Shared\GIS\NewProjectApplication\Hidden\Conway_sdeVector_sdeViewer.sde\SDEVECTOR.SDEDATAOWNER.V_CONSTRUCTIONPROJECT_EAM"
        ...
        ## Meter
        ##
        meter = r"R:\Divisions\InfoTech\Shared\GIS\NewProjectApplication\Hidden\Conway_sdeVector_sdeViewer.sde\SDEVECTOR.SDEDATAOWNER.V_WSERVICELOCATION_EAM"
        ...
        ## Water Lateral
        ##
        lateral = r"R:\Divisions\InfoTech\Shared\GIS\NewProjectApplication\Hidden\Conway_sdeVector_sdeViewer.sde\SDEVECTOR.SDEDATAOWNER.V_WLATERAL_EDM"
